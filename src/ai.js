...
function 拡大解釈の文(強度目盛, 入か) {
  ...
  /* 飛んだ先で何を選ぶかは、強度が決める */
  const 飛び先 = 目 <= 2
    ? ['・★飛んだ先でも、**その界隈の王道**を選んでください。',
      '　遠くへは行くが、行った先では代表格を選ぶ ―― という広げ方です']
    : (目 === 3
      ? ['・飛んだ先では、王道と端のものを混ぜてください']
      : ['・★飛んだ先でも、**端のほう**を選んでください。',
        '　遠くへ行ったうえで、そこでも意外なものを選ぶ ―― という広げ方です']);
  return [
    '・★**後半は、遠くの文脈まで広げてください。**',
    '　前半でその気分の足場を作り、後半は思い切って飛んでよい。',
    '　聴き手が「そう来たか」と思うところまで行って構いません',
    ...飛び先,
...
function プレイリストの頼み文(気分, 曲数, 響き = '', 演者の数 = 0, 強度 = 強度の段[既定の目盛 - 1], 拡大解釈 = null) {
  return [
     ...
     */
    '・★イントロ・アウトロ・つなぎの小品は選ばないでください。',
    '　単独で聴いて 1 曲として成り立つものだけにしてください',
