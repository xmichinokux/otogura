...
module.exports = { 拡大解釈の文, 中断する, 止められたか, ジャンルを埋めさせる, ジャンルをまとめさせる, 木を混ぜる, 使うモデル, 候補の数, 作る曲数, 見せる演者の数, 目盛の数, 既定の目盛, 幅の段, 量の段, 強度の段, 幅を読む, 量を読む, 強度を読む, 曲数を丸める, ジャンル一覧を作る, 頼み文, 照らし合わせる, おすすめを聞く, プレイリストの頼み文, 並びを確かめる, プレイリストを作らせる, 木の頼み文, 木を生やす };
