...
const 訳 = {
  en: {
    ...
    'どのタブの選択も、まとめて外します': "Clears the selections on every tab at once",
    ...
    'このタブに {n} 個残っています（いまは効きません。押すと効きます）': "{n} left on this tab (not in effect now; press the tab to apply it)",
